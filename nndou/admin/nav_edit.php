 ...
 if(isset($_GET['edit'])&&!empty($_GET['edit'])){
    $sql='SELECT * FROM nnd_nav WHERE nav_id='.$_GET['edit'];
    $infos=find($sql);
 ...
 if(isset($_POST)&&!empty($_POST)){
        ...
        $navurl = $_POST['navurl'];
        //修改数据的sql语句
        $sql="UPDATE  nnd_nav SET  `nav_name` = '$navname',`nnd_url`='$navurl' WHERE `nav_id`=$id";
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="" method="post" class="cmxform" id="uploadForm" enctype='multipart/form-data'>
                        <input type="hidden" name="navid" value="<?php  echo $infos['nav_id'];  ?>" />
                        <div class="panel">
                                ...
                                <div class="col-md-7">
                                     ...
                                     <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">导航名称</span>
                                            <input type="text" name="navname" value="<?php echo $infos['nav_name'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">跳转的url地址</span>
                                            <input type="text" name="navurl" value="<?php echo $infos['nnd_url'] ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-7">
