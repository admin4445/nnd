    <?php 
        ...
        if(isset($_POST['sub'])){
            ...
            $sql="INSERT INTO nnd_case_type (`case_type_name1`,`case_type_name2`,`case_type_thumb`) VALUES( '$name',' $title','$imgpath')";
            $res=insert($sql);
            if($res['code']==1){
                echo "<script> alert('添加成功');window.location.href='casetype_list.php';</script>";
            }else{
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">英文名</span>
                                            <input type="text" name="case_type_ename" value="" class="form-control">
                                        </div>
                                    </div>
