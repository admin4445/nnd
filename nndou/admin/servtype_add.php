    <?php 
        ...
        if(isset($_POST['sub'])){
            ...
            $sql="INSERT INTO nnd_serv_type (`serv_type_name`,`serv_type_title`,`serv_type_desc`,`serv_type_thumb`) VALUES( '$name',' $title',' $content','$imgpath')";
           $res=insert($sql);
           if($res['code']==1){
                echo "<script> alert('添加成功');window.location.href='servtype_list.php';</script>";
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">标题</span>
                                            <input type="text" name="ser_type_title" value="" class="form-control">
                                        </div>
                                    </div>
